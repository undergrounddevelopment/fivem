-- =====================================================
-- PUSH ALL DATA TO: https://peaulqbbvgzpnwshtbok.supabase.co
-- Copy paste ke SQL Editor dan RUN
-- =====================================================
...
INSERT INTO users (discord_id, username, email, membership, coins, is_admin) VALUES
('ADMIN_DISCORD_ID', 'Admin', 'admin@fivemtools.com', 'admin', 999999, true)
ON CONFLICT (discord_id) DO NOTHING;

INSERT INTO forum_categories (name, description, icon, order_index) VALUES
('General Discussion', 'General topics', '💬', 1),
('Script Help', 'Get help', '🔧', 2),
('MLO Showcase', 'Share MLOs', '🏢', 3),
('Vehicle Releases', 'Share vehicles', '🚗', 4),
('Script Releases', 'Share scripts', '📜', 5),
...
('Welcome!', 'Welcome to FiveM Tools V7', 'info'),
('New Assets', 'Check out new assets!', 'success');
...
-- =====================================================
-- SELESAI! Tables & Sample Data Created
-- =====================================================
-- Untuk import 300+ users, jalankan file:
-- database-dump/complete_data_dump.sql
-- di SQL Editor berikutnya
-- =====================================================
